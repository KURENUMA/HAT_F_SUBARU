...
{
    public partial class SalesCorrectionList : Form
    {
        // TODO: 画面固有のvGridManagervを定義
        private class SalesCorrectionListManager : GridManagerBase<ViewSalesCorrection> { }

        // TODO: TemplateGridManager から画面用の固有型へ変更 (GridManagerBase<T>の継承で作れます)
        private SalesCorrectionListManager gridManager = new SalesCorrectionListManager();
        ...
        private const string OUTFILE_NAME = "売上訂正一覧_yyyyMMdd_HHmmss";

        public SalesCorrectionList()
        {
            InitializeComponent();           
        ...
        private void SalesCorrectionList_Load(object sender, EventArgs e)
        {
            // TODO:引数を変更
        ...
        private void SalesCorrectionList_FormClosed(object sender, FormClosedEventArgs e)
        {
