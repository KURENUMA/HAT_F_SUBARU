...
{
    partial class InterestRate_BeforeFix
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InterestRate_BeforeFix));
            ...
            this.Name = "InterestRate_BeforeFix";
            this.ShowIcon = false;
            this.Text = "売上確定前　利率異常チェック";
            this.Load += new System.EventHandler(this.InterestRate_BeforeFix_Load);
