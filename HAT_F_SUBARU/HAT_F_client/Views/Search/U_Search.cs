...
{
    /// <summary>請書取込検索画面</summary>
    public partial class U_Search : Form
    {
        ...
        private void JH_Search_Jyutyu_Load(object sender, EventArgs e)
        {
        ...
        private void BtnDelete(object sender, System.EventArgs e)
        {
            ...
            MessageBox.Show(this.btnDelete.Text);
        }
        #endregion
        ...
        {
            this.txtEAMCD.Clear();
            this.txtSNAIBU.Clear();
            this.txtDKUBUN.Clear();
            this.txtDNO.Clear();
            this.txtKYAKUCHU.Clear();
            this.txtREC_TERM.Clear();
            this.txtTORIKOMI.Clear();
        ...
        private void SetLayOutData()
        {
            ...
            ListLayOut.Add("2,内部No,Dseq,70,,M,1,1");
            ListLayOut.Add("3,伝区,Hkbn,100,,L,1,1");
            ListLayOut.Add("4,伝票No,DenNo,70,,M,1,1");
            ListLayOut.Add("5,HAT注番,HatOrderNo,80,,M,1,1");
            ListLayOut.Add("6,得意先,TokuiCd,70,,M,1,1");
            ListLayOut.Add("7,客先注番,CustOrderno,120,,L,1,1");
            ListLayOut.Add("8,現場,GenbaCd,50,,M,1,1");
            ListLayOut.Add("9,仕入先,ShiresakiName,70,,M,1,1");
            ListLayOut.Add("10,受注日,RecYmd,90,d,M,1,1");
            ListLayOut.Add("11,納期,Nouki,90,d,M,1,1");
            ListLayOut.Add("12,受注者名,Jyu2Name,120,,L,1,1");
            ListLayOut.Add("13,取込,Torikomi,50,,L,1,1");
            ListLayOut.Add("14,メーカー区分,RecTerm,200,,L,1,1");
        }
        ...
        private void testData()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                dr["GenbaCd"] = "123";
                dr["ShiresakiName"] = "123456";
                dr["RecYmd"] = "23/01/01";
                dr["Nouki"] = "24/03/31";
                dr["Jyu2Name"] = "ＮＮＮ　ＮＮＮ";
                dr["Torikomi"] = "ＮＮ";
                dr["RecTerm"] = "1234567890";
                DtList.Rows.Add(dr);
