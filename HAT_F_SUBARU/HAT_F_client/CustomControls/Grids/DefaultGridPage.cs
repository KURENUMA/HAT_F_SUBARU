...
{
    public partial class DefaultGridPage : UserControl
    {
        ...
        public DefaultGridPage(IGridManager manager) : this(manager, null)
        {
        }

        //public DefaultGridPage(TemplateGridManagerPage manager, GridOrderManager orderManager)
        public DefaultGridPage(IGridManager manager, GridOrderManager orderManager)
        {
            InitializeComponent();
        ...
        //public void DefaultGridPage_DataSourceChange(object sender, EventArgs args)
        //{
        //    IndexRowNumbers();
        //    this.pagination1.TotalPages = _manager.TotalPages;
        //}

        //public void DefaultGridPage_PageChange(object sender, int page)
        //{
        //    _manager.SetCurrentPage(page);
        //    _manager.Reload();
        //}
        ...
        public void InitialEvents()
        {
            ...
            this.pagination1.onPageChange += async (object sender, int page) =>
            {
                _manager.SetCurrentPage(page);
