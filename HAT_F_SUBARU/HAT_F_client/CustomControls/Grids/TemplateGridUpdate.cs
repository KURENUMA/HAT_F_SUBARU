...
{
    public partial class TemplateGridUpdate : UserControl
    {
        private TemplateGridManagerUpdate _manager;
        //private GridOrderManager _orderManager;

        public TemplateGridUpdate(TemplateGridManagerUpdate manager = null, GridOrderManager orderManager = null)
        {
            _manager = manager;
