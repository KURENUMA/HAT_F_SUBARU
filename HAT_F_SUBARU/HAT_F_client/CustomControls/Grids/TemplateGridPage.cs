...
{
    public partial class TemplateGridPage : UserControl
    {
        private TemplateGridManagerPage _manager;
        //private GridOrderManager _orderManager;

        public TemplateGridPage(TemplateGridManagerPage manager = null, GridOrderManager orderManager = null)
        {
            _manager = manager;
