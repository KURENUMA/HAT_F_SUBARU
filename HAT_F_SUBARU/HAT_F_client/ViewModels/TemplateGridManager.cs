...
{
    public class TemplateGridManager : IGridManager
    {
        ...
        public async Task<bool> Reload(List<FilterCriteria> filters)
        {
            ...
            var resp = await Program.HatFApiClient.PostAsync<List<ViewReadySale>>(ApiResources.HatF.Search.ViewReadySale, JsonConvert.SerializeObject(conditions));
